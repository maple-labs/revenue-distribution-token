...
contract ConvertViewTests is TestUtils {
    ...
    function setUp() public virtual {
        ...
        rdToken =
        new MockRDT("Revenue Distribution Token", "RDT", address(this), address(asset), 1e30);
        staker = new Staker();
        vm.warp(10_000_000); // Warp to non-zero timestamp for __setTotalAssets
    }

    function test_convertToShares(uint256 totalAssets_, uint256 mintAmount_)
        public
    {
    ...
    function test_convertToAssets(uint256 totalAssets_, uint256 mintAmount_)
        public
    {
        totalAssets_ = constrictToRange(mintAmount_, 1, 1e29);
        mintAmount_ = constrictToRange(mintAmount_, 1, totalAssets_); // So totalAssets > totalSupply
...
contract MaxViewTests is TestUtils {
    ...
    function test_maxRedeem(uint256 totalAssets_, uint256 mintAmount_)
        public
    {
        totalAssets_ = constrictToRange(mintAmount_, 1, 1e29);
        mintAmount_ = constrictToRange(mintAmount_, 1, totalAssets_); // So totalAssets > totalSupply
    ...
    function test_maxWithdraw(uint256 totalAssets_, uint256 mintAmount_)
        public
    {
        totalAssets_ = constrictToRange(mintAmount_, 1, 1e29);
        mintAmount_ = constrictToRange(mintAmount_, 1, totalAssets_); // So totalAssets > totalSupply
...
contract PreviewViewTests is TestUtils {
    ...
    function test_previewDeposit(uint256 totalAssets_, uint256 mintAmount_)
        public
    {
        totalAssets_ = constrictToRange(mintAmount_, 1, 1e29);
        mintAmount_ = constrictToRange(mintAmount_, 1, totalAssets_); // So totalAssets > totalSupply
    ...
    function test_previewMint(uint256 totalAssets_, uint256 mintAmount_)
        public
    {
        totalAssets_ = constrictToRange(mintAmount_, 1, 1e29);
        mintAmount_ = constrictToRange(mintAmount_, 1, totalAssets_); // So totalAssets > totalSupply
