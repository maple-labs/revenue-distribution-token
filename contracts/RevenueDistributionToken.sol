...
import {IRevenueDistributionToken} from
...
contract RevenueDistributionToken is IRevenueDistributionToken, ERC20 {
        ...
        returns (uint256 issuanceRate_, uint256 freeAssets_)
    {
        ...
        // Calculate slope.
        issuanceRate_ = (
            issuanceRate = (ERC20(asset).balanceOf(address(this)) - freeAssets_) *
                precision
                / vestingPeriod_
        );
    ...
    function _updateIssuanceParams()
        internal
        returns (uint256 issuanceRate_)
    {
        ...
        returns (uint256 assets_)
    {
        ...
        assets_ =
            supply == 0 ? shares_ : _divRoundUp(shares_ * totalAssets(), supply);
    }
        ...
        returns (uint256 shares_)
    {
        ...
        shares_ =
            supply == 0 ? assets_ : _divRoundUp(assets_ * supply, totalAssets());
    }
