...
contract RevenueDistributionToken is IRevenueDistributionToken, ERC20 {
    ...
    function _deposit(uint256 amount_) internal returns (uint256 shares_) {
    ...
    function _redeem(uint256 rdTokenAmount_) internal returns (uint256 underlyingAmount_) {
    ...
    function _withdraw(uint256 underlyingAmount_) internal returns (uint256 shares_) {
